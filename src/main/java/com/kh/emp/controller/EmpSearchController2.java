...
public class EmpSearchController2 extends AbstractController {
	...
	public String doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		param.put("searchType", request.getParameter("searchType")); // null이거나 ''일수 있다.
		param.put("searchKeyword", request.getParameter("searchKeyword")); // null이거나 ''일수 있다.
		...
		param.put("hireDate", request.getParameter("hireDate")); // null이거나 ''일수 있다.
